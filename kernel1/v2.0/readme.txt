...
Kernel 1 version 2.0

Unlike version 1.0, this version uses a different calling convention:

_stacklist and _stacklist_index are no longer present. Instead, functions will use the main stack, (call stack procedure).
...
WARNING:
Unfortunatelly, there are some significant limitations with values in the ARM architecture.
You may not use an immediate value bigger than 12bits, and you may not reference this value in a memory address that is further than 4kiB away from the code.
